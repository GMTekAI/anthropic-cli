...
var betaVaultsRetrieve = cli.Command{
	...
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:      "vault-id",
			Usage:     "Unique identifier of the vault to retrieve.",
			Required:  true,
			PathParam: "vault_id",
		},
		&requestflag.Flag[[]string]{
...
var betaVaultsUpdate = cli.Command{
	...
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:        "vault-id",
			Usage:       "Unique identifier of the vault to update.",
			Required:    true,
			PathParam:   "vault_id",
...
var betaVaultsDelete = cli.Command{
	...
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:      "vault-id",
			Usage:     "Unique identifier of the vault to delete.",
			Required:  true,
			PathParam: "vault_id",
		},
		&requestflag.Flag[[]string]{
...
var betaVaultsArchive = cli.Command{
	...
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:      "vault-id",
			Usage:     "Unique identifier of the vault to archive.",
			Required:  true,
			PathParam: "vault_id",
		},
		&requestflag.Flag[[]string]{
